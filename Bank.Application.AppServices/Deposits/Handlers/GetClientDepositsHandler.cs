...
public class GetClientDepositsHandler : IGetClientDepositsHandler
{
    ...
    public GetClientDepositsHandler(IDepositRepository repository, IClientRepository clientRepositoryrepository)
    {
